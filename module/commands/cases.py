...
def getCases(all_cases, query):
    ...
    for row in result:
        ...
        case_quantity = row[2]
        case_status = row[3]
        case_quoted_name = urllib.parse.quote(case_name)
        case_url = "https://steamcommunity.com/market/listings/730/"+case_quoted_name
        ...
        response = requests.get(f"http://steamcommunity.com/market/priceoverview/?appid=730&currency=6&market_hash_name={case_quoted_name}").json()
